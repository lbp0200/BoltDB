...
func init() {
	commands := []cmdInfo{
		...
		{name: "MIGRATE", arity: -6, flags: []commandFlag{flagWrite, flagDenyOOM}},
		...
		{name: "XGROUP", arity: -2, flags: []commandFlag{flagWrite}, firstKey: 1, lastKey: 1, step: 1},
		...
		{name: "XREAD", arity: -4, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: -1, step: 1},
		{name: "XREADGROUP", arity: -7, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: -1, step: 1},
		...
		{name: "ZINTER", arity: -3, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: -1, step: 1},
		...
		{name: "ZUNION", arity: -3, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: -1, step: 1},
