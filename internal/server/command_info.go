...
func init() {
	commands := []cmdInfo{
		...
		{name: "GEOSEARCH", arity: -5, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: 1, step: 1},
		{name: "GEOSEARCHSTORE", arity: -5, flags: []commandFlag{flagWrite, flagDenyOOM}, firstKey: 1, lastKey: 2, step: 1},
