...
func init() {
	commands := []cmdInfo{
		...
		{name: "BGREWRITEAOF", arity: 1, flags: []commandFlag{flagAdmin, flagNoscript}},
		{name: "RESET", arity: 1, flags: []commandFlag{flagNoscript, flagReadonly}},
		{name: "WAITAOF", arity: 4, flags: []commandFlag{flagNoscript}},
		...
		{name: "FAILOVER", arity: -2, flags: []commandFlag{flagAdmin, flagNoscript}},
		...
		{name: "RESTORE-ASKING", arity: -4, flags: []commandFlag{flagWrite, flagDenyOOM}, firstKey: 1, lastKey: 1, step: 1},
