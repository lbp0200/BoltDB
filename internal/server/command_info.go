...
func init() {
	commands := []cmdInfo{
		...
		{name: "GEORADIUS", arity: -5, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: 1, step: 1},
		...
		{name: "GEOSEARCH", arity: -6, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: 1, step: 1},
		{name: "GEOSEARCHSTORE", arity: -7, flags: []commandFlag{flagWrite, flagDenyOOM}, firstKey: 1, lastKey: 2, step: 1},
		...
		{name: "HSCAN", arity: -2, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: 1, step: 1},
		...
		{name: "OBJECT", arity: -2, flags: []commandFlag{flagReadonly}, firstKey: 2, lastKey: 2, step: 1},
		...
		{name: "SSUBSCRIBE", arity: -2, flags: []commandFlag{flagPubSub, flagNoscript, flagReadonly}},
		...
		{name: "SPUBLISH", arity: 3, flags: []commandFlag{flagPubSub, flagWrite}},
		...
		{name: "SUNSUBSCRIBE", arity: -1, flags: []commandFlag{flagPubSub, flagNoscript, flagReadonly}},
		...
		{name: "REPLCONF", arity: -2, flags: []commandFlag{flagAdmin, flagReadonly}},
		...
		{name: "SINTERCARD", arity: -3, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: -1, step: 1},
		...
		{name: "SSCAN", arity: -2, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: 1, step: 1},
		...
		{name: "XADD", arity: -4, flags: []commandFlag{flagWrite, flagDenyOOM}, firstKey: 1, lastKey: 1, step: 1},
		{name: "XAUTOCLAIM", arity: -5, flags: []commandFlag{flagWrite}, firstKey: 1, lastKey: 1, step: 1},
		{name: "XCLAIM", arity: -5, flags: []commandFlag{flagWrite}, firstKey: 1, lastKey: 1, step: 1},
		...
		{name: "XDELEX", arity: -3, flags: []commandFlag{flagWrite}, firstKey: 1, lastKey: 1, step: 1},
		{name: "XGROUP", arity: -4, flags: []commandFlag{flagWrite}, firstKey: 1, lastKey: 1, step: 1},
		{name: "XINFO", arity: -2, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: 1, step: 1},
		...
		{name: "XREAD", arity: -3, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: -1, step: 1},
		{name: "XREADGROUP", arity: -4, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: -1, step: 1},
		...
		{name: "XTRIM", arity: -3, flags: []commandFlag{flagWrite}, firstKey: 1, lastKey: 1, step: 1},
		...
		{name: "ZINTERCARD", arity: -3, flags: []commandFlag{flagReadonly}, firstKey: 1, lastKey: -1, step: 1},
		...
		{name: "BZMPOP", arity: -5, flags: []commandFlag{flagWrite, flagDenyOOM, flagNoscript}, firstKey: 2, lastKey: -1, step: 1},
